...
function LoginForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await authorizedFetch('http://localhost:5229/auth/register', {
                method: 'POST',
                body: JSON.stringify({
            ...
            <div
                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="/login" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label form="remember" className="text-gray-500 dark:text-gray-300">Remember
                                        me</label>
                                </div>
                            </div>
                            <a href="#"
                        ...
                        {loggedIn && <p className="text-sm font-medium text-green-500 dark:text-green-400">
